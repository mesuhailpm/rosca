    ...
    return (
        <div className='bg-blue-300/50 h-screen pt-4'>
            ...
            <form action="" className='flex flex-col items-center mt-4 font-sans' onSubmit={handleRegister}>
                ...
                <button disabled={!((formData.userName) && (formData.password) && (formData.password === formData.confirmPassword))} type='submit' className='border border-none bg-green-600 text-yellow-100 m-4 pl-4 pr-4 p-2 rounded-md hover:bg-green-500 hover:border-white'>Register</button>
            </form> 
        </div>
    )
}
