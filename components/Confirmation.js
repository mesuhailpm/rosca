...
import failedIcon from 'public/assets/images/failed-icon.png'
  ...
  return (
    <div className='flex flex-col justify-center items-center border border-4 p-2 h-40 border-black rounded-xl gap-4 font-bold bg-white/75
     left-1/2 top-1/2
      ...
      >
        <h1>{`${message}!`}</h1> 
        <Image src={success ? completeIcon: failedIcon} width={40} className='border border-black rounded-full' alt='success logo'/>
